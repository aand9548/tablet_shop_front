...
const createAndEditProductModalContent = () => {
    return `<form name="productForm" enctype="multipart/form-data" method="post">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <td class="form-label"><label for="productModel">Model:</label> </td>
                        <td class="form-input"><input type="text" name="productModel" id="productModel" class="form-control" required></td>
                    </tr>
                    
                    <tr>
                        <td class="form-label"><label for="productSize">Size:</label> </td>
                        <td class="form-input"><input type="number" name="productSize" id="productSize" class="form-control" min="7" max="15" required></td>
                    </tr>

                    <tr>
                        <td class="form-label"><label for="productResolution">Resolution:</label> </td>
                        <td class="form-input">
                            <select name="productResolution" id="productResolution" class="form-select" required>
                                <option>1024x768</option>
                                <option>1280x800</option>
                                <option>1366x768</option>
                                <option>1800x1200</option>
                    ...
                    <tr>
                        <td class="form-label"><label for="productVolume">Volume, GB:</label> </td>
                        <td class="form-input"><input type="number" name="productVolume" id="productVolume" class="form-control" min="1" max="2000" required></td>
                    </tr>

                    <tr>
                        <td class="form-label"><label for="productBattery">Battery, mAh:</label> </td>
                        <td class="form-input"><input type="number" name="productBattery" id="productBattery" class="form-control" min="1000" max="8000" required></td>
                    </tr>
