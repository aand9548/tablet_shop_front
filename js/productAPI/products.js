...
function editProduct(id, name, price, model, size, res, volume, battery, img, cloud) {
    convertModalToEdit();
    ...
    document.getElementById('productResolution').value = res;
    document.getElementById('productVolume').value = volume;
    document.getElementById('productBattery').value = battery;
