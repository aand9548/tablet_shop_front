function productCardRender(product) {
    ...
    const commonProductCardPart = `<div class="product-data">
                                        ...
                                        <div class="product-text">Model: <span class="product-model">${product.productModel}</span> </div> 
                                        <div class="product-text">Size: <span class="product-size">${product.productSize}</span>"</div> 
                                        <div class="product-text">Resolution: <span class="product-resolution">${product.productResolution}</span> </div> 
                                        <div class="product-text">Volume: <span class="product-volume">${product.productVolume}</span> GB</div> 
                                        <div class="product-text">Battery: <span class="product-battery">${product.productBattery}</span> mAh</div> 
                                    </div>`;
    const adminProductCardFooter = `  <div class="product-footer">
                                        ...
                                        <div class="product-manage-btns">
                                            <div class="fas fa-edit product-btn" onclick="editProduct('${product._id}', '${product.productName}', '${product.productPrice}', '${product.productModel}', '${product.productSize}', '${product.productResolution}', '${product.productVolume}', '${product.productBattery}', '${product.productImage}', '${product.cloudinaryPublicId}')"> </div>
